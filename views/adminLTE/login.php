...
<head>
  ...
  <title>AdminLTE 2 | Loja 2.0 - Painel Login</title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo BASE_URL; ?>assets/iCheck/skins/square/blue.css" type="text/css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Admin da Loja </b> 2.0</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <?php endif; ?>
    <form action="<?php echo BASE_URL; ?>login/adminLogar/" method="post">
